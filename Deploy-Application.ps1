...
Try {
	...
	[string]$appVersion = ' 2023.001.20064'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "MsiExec.exe" -Parameters "/i $dirFiles\AcroRead.msi EULA_ACCEPT=YES DISABLEDESKTOPSHORTCUT=1 /qn" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }

		$exitCode = Execute-Process -Path "MsiExec.exe" -Parameters "/p $dirFiles\AcroRdrDCUpd2300120064.msp /qn" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAq/OP9AAIuTlkE
# b4SgvIMBdhSpkMHKr0yqpqx0yNSPY6CCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgc4JACOfEk59r
# /UoMNnaNnWj1BskSJ4UCjZrf+tTFzMswDQYJKoZIhvcNAQEBBQAEggGAaEgfF+q8
# 5VZwM2aKEEMc4sYz2Yvr16FzUo/Bqj73+JYnU57gyXkvBs5rWzhfFCRINx0dsyBQ
# /HIJIl3A3qjeL3dF8fx6aGgTnNpstP0cgfzNgyuyJDt5jY/Ytb/TdvyPPaWzAwg4
# 1h93e2skBUdbg0+BShqx5P3TpEaUmIzMUckpBn/LV6nqCeT2O+poqY0pJIoaMJJj
# 33W2E+bp3b6SsJIiCfuFGUieupUoxDj4hRAU5ibG28WMwKLTu1vv6MT+cFEfEL24
# iB/0nTbjHFAD1LOQavtpscu3wx3vif0R9UeCOmumhCygQpAjPMs7pXgpQtDEBfKL
# ePrZNSFUg5di01H+ditY4ZBwEo/tmtgw+LlkTAMQhfvPOwTIZyIaqvp3br7vEfQU
# LW+BfppIX1rhmOKhVAHl6BE3pTbw8ElLN2L63o9L1sRzT9uRADTWZttFuzmtTzcb
# xZL8GcSQjn5/7zH+e18hESxdVMt7j2BiCDXk3+D96BJkYboINHnykNjBoYIDTDCC
...
# MjQyMzRaMD8GCSqGSIb3DQEJBDEyBDB21UCrCc9p+fwx4ZMR8F9PQe95JeFB4Tcu
# fzCZyM2kMQeA0mMhpoTr3bd4u9B5ltgwDQYJKoZIhvcNAQEBBQAEggIAhxCDRT/B
# mBT9ySNVUSBONI2YQQYbib+ojJa/ZjSICAzkONUpbjY3gOxKNvIkQQGASKlLhRMS
# 8QxG0l68pZx/1xw+BvxCNFy4tCoFJOfC6CII8KFyHdXLy1mJSQ0SooFzRgQxSuqw
# zMGHPYc4qmZaC0tTmjU7AViUWqvEf+RZCq/bq32Wulne+ngx0W8vhPkHS/RYJXdX
# YDnbkc12n6RfXKbQvsco2s+h454Pdg87g5J35KIbnOHOHnLADFzWgvbhmOOYpg83
# 0+ir/AK+lU+fcZ8Iyld8GLGCSIVeB8eWAENGog6IhjZZKc02FvBtQB7K3vldVpex
# BtP0kXe0Joq480oCrLm05GF7r2LnWPL9OEEeQPVusOvHm+7YVegDOKrozjpOiOS6
# ilHEyh1W/i1gmxPsjyidLvOLc7mnpV+hQEZt9FCBc3SXSyIwcufUZ3E3/KtrPb3d
# HtraHcjS8olLmV3kiRtM/yhqwJoersIgn8N89hTVdaz2zD9NfnEeQuEwQk90K6h5
# CPYGZ58fREIenn9lAmn8NZEgpF7DAbbKalHc32Y5o4z4irW0wwROK2wYlR49z+/o
# z4XJWa73elJR5geWNNlyjyp87S//9HEXCXumIzmtQQDc6dN1c6HOzzNrEhdsHu5e
# j62MByQXpXTsGfI9LxthAgCgU8pzODaFR/o=
